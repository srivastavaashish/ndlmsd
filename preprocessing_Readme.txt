...
- Split data into training (70%), validation (10%), and test (20%) sets using stratified sampling on the time attribute to ensure a uniform distribution of time periods across the splits.
